...
public class RegistrarTrilhaActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carregarConfiguracoes(); // Carrega configurações persistentes
    ...
    private void carregarConfiguracoes() {
        ...
        tipoMapa = prefs.getInt("tipo_mapa", GoogleMap.MAP_TYPE_NORMAL);
        courseUp = prefs.getBoolean("course_up", false);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CONFIG && resultCode == RESULT_OK) {
            carregarConfiguracoes(); // Atualiza com as novas configurações salvas
